<template lang="pug">
  ...
  div.hello
    ...
    h2 Essential Links
    ul
      li: a(href='https://vuejs.org', target='_blank') Core Dos
      li: a(href='https://forum.vuejs.org', target='_blank') Forum
      li: a(href='https://chat.vuejs.org', target='_blank') Chat
    ...
    ul
      ...
      li: a(href='http://github.com/vuejs/awesome-vue', target='_blank') awesome-vue
